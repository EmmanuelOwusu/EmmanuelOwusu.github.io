...
* Predicting the price of wine based on a collection of reviews and  product features.

* We used the Random Forest Regressor and the XGBoost model to predict the prices of wine.
